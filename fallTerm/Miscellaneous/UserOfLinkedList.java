...
public class UserOfLinkedList {
    ...
    public static void main(String[] commandLine) {
        ...
        // lastOfList test
        System.out.println( System.lineSeparator() + "lastOfList: " + System.lineSeparator()
                          + shopping.lastOfList()  + System.lineSeparator()
                          + new LinkedList().lastOfList()  + System.lineSeparator()
                          + System.lineSeparator());
